...
from robosapiens_tool_utils.keypoints import extract_keypoints, group_keypoints
from robosapiens_tool_utils.pad_width import  pad_width
from robosapiens_tool_utils.load_state import  load_state
from robosapiens_tool_utils.normalize import normalize
from robosapiens_tool_utils.with_mobilenet import PoseEstimationWithMobileNet



class HighResolutionPoseEstimation():
    ...
    def __init__(self, device='cuda', backbone='mobilenet',
        ...
        self.mobilenet_use_stride = mobilenet_use_stride
        ...
        self.method = method
        self.percentage_around_crop = percentage_around_crop
    ...
    def load(self):
        ...
        checkpoint_path = cwd + '/models/checkpoint_iter_370000.pth'
